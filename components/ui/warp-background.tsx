...
const Beam = ({
  ...
  // Use useState with a lazy initializer to generate these values only once
...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  // Set a mounted flag to ensure random parts are only rendered on the client.
  ...
  // Only generate beams when mounted to avoid hydration mismatches.
